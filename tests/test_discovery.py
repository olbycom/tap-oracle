...
try:
    from tests.utils import ensure_test_table, get_test_conn_config, get_test_connection
except ImportError:
...
class TestStringTableWithPK(unittest.TestCase):
    ...
    def setUp(self):
        table_spec = {
            "columns": [
                {"name": "id", "type": "integer", "primary_key": True, "identity": True},
        ...
        with get_test_connection() as conn:
            ...
            self.assertEqual(
                ...
                [
                    ...
                    {
                        "metadata": {"inclusion": "automatic", "sql-datatype": "NUMBER", "selected-by-default": True},
                        "breadcrumb": ("properties", "ID"),
                    },
                    {
                        "metadata": {"inclusion": "available", "sql-datatype": "CHAR", "selected-by-default": True},
                    ...
                    {
                        "metadata": {"inclusion": "available", "sql-datatype": "NCHAR", "selected-by-default": True},
                    ...
                    {
                        "metadata": {"inclusion": "available", "sql-datatype": "VARCHAR2", "selected-by-default": True},
...
class TestIntegerTablePK(unittest.TestCase):
    ...
    def setUp(self):
        table_spec = {
            "columns": [
                {"name": "size_pk", "type": "number(4,0)", "primary_key": True, "identity": True},
            ...
            self.assertEqual(
                {
                    "schema": {
                        "properties": {
                            "size_number_10_-1": {"multipleOf": 10, "type": ["null", "integer"]},
...
class TestDecimalPK(unittest.TestCase):
    ...
    def setUp(self):
        table_spec = {
            "columns": [
                {"name": '"our_number"', "type": "number", "primary_key": True},
            ...
            self.assertEqual(
                {
                    "schema": {
                        "properties": {
                            "our_number": {"multipleOf": 1e-38, "type": ["number"]},
                            "our_number_10_2": {"multipleOf": 0.01, "type": ["null", "number"]},
                            "our_number_38_4": {"multipleOf": 0.0001, "type": ["null", "number"]},
                        },
                        "type": "object",
                    },
                    "stream": "CHICKEN",
            ...
            self.assertEqual(
                {
                    ...
                    "metadata": [
                        ...
                        },
                        {
                            ...
                            "metadata": {"inclusion": "automatic", "sql-datatype": "DATE", "selected-by-default": True},
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "metadata": {
                                "inclusion": "available",
                                "sql-datatype": "TIMESTAMP(6) WITH LOCAL TIME ZONE",
                                "selected-by-default": True,
                            },
                        },
                    ],
            ...
            self.assertEqual(
                {
                    "schema": {
                        "properties": {
                            "our_float": {"type": ["number"], "multipleOf": 1e-38},
                            "our_double_precision": {"type": ["null", "number"], "multipleOf": 1e-38},
                            "our_real": {"type": ["null", "number"], "multipleOf": 1e-18},
    ...
    def test_catalog(self):
        with get_test_connection() as conn:
            ...
            for s in catalog.streams:
                schema_name = [
                    md["metadata"]["schema-name"] for md in s.metadata if md["breadcrumb"] == () and md["metadata"]
                ][0]
